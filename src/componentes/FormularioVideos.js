        ...
        <Container maxWidth="xl" >
          <form onSubmit={handleSubmit(onSubmit)}>
            <Grid rowSpacing={5} container sx={{
              ...
              <Grid item xs={12}  >
                <Typography align='center' variant='h3' color="#ffffff"  > Nuevo Anime</Typography>
              ...
              <Grid item xs={12}>
                <FormControl fullWidth>
                  <InputLabel id="demo-simple-select-helper-label">Escoja una genero</InputLabel>
                  <Controller
                    name="Categoria"
                    control={control}
                    defaultValue=""
              ...
              <Grid item xs={12} direction="row" sx={{ display: 'flex', justifyContent: 'space-between' }} >
                ...
                <CategoriaButton onClick={iraCategoria}  sx={{ width: 200 }} variant="contained" size="large" >Nuevo Genero</CategoriaButton>
